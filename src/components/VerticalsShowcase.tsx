...
export default function VerticalsShowcase() {
  ...
  useEffect(() => {
    ...
    // forward in sequence, ending on DIGITAL. Runs on every screen
    // size: it only reads scroll position and sets a transform, it
    // never fights the browser's own scrolling the way true
    // scroll-hijacking would.
    const compute = () => {
      ticking = false;
  ...
  return (
    <div ref={wrapperRef} className="relative h-[400vh] bg-white">
