...
// Solid brand marks (not thin outline strokes) — reads as a proper
// wordmark/logo rather than a generic wireframe icon-in-a-circle.
// lucide-react dropped brand/social icons entirely, so these are
// plain inline SVGs using each brand's standard glyph.
